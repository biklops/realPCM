...
/***/ function(module, exports) {
	...
	$('.main-menu-wrap').append('<canvas id="menu-canvas"></canvas>');
	...
	MenuTransition = function () {
	    ...
	    setTimeout(function () {
	        ...
	        Part.prototype.update = function () {
	            ...
	            this.radius = this.radius + this.expandRate;
	        ...
	        Part.prototype.render = function () {
	            ...
	            ctx.fillStyle = ctx.strokeStyle = '#fe4566';
